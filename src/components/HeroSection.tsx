        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link
                to="/contact"
                className="inline-flex items-center justify-center px-6 py-3 bg-white border border-border shadow-sm rounded-full font-medium transition-all hover:shadow-md"
              >
                Bagikan Ceritamu
              </Link>
            </div>
          ...
          >
            ...
            <div className="absolute top-1/2 -right-5 transform -translate-y-1/2 glass rounded-lg shadow-lg p-3 animate-fade-in">
